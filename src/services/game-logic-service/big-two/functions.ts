...
export const getFreshGameState = (playerIds: string[]): GameState => ({
...
export const makePass = (pass: Pass) => (gameState: GameState): Effect.Effect<GameState, GameLogicError> => pipe(
...
export const makePlay = (play: Play) => (gameState: GameState): Effect.Effect<GameState, GameLogicError> => pipe(
    Effect.succeed(gameState),
